...
import com.traza.core.geometry.capture.HorizontalSurface
...
import com.traza.core.geometry.capture.SamplingConfig
...
data class FloorState(
    ...
    val isEstablished: Boolean get() = area >= com.traza.core.geometry.capture.FloorSelector.ESTABLISHED_AREA
