...
import com.traza.ar.ArScene
import com.traza.ar.ArSegment
import com.traza.ar.CaptureMode
import com.traza.ar.MeasureArController
import com.traza.core.data.CalibrationStore
import com.traza.core.data.MeasureData
import com.traza.core.data.MeasureRepository
import com.traza.core.designsystem.hintRes
import com.traza.core.designsystem.messageRes
...
import com.traza.core.geometry.RoomSolution
...
import com.traza.core.geometry.capture.ClosingIntent
import com.traza.core.geometry.capture.CornerSnapper
import com.traza.core.geometry.capture.LoopClosure
import com.traza.core.geometry.capture.MeasuredSegment
import com.traza.core.geometry.capture.MeasurementMode
import com.traza.core.geometry.capture.SampledPoint
...
class CaptureViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun updateStartProximity(reticle: com.traza.core.geometry.Vec3?) {
    ...
    private fun distanceToStart(point: com.traza.core.geometry.Vec3?): Double? {
    ...
    fun formatArea(solution: RoomSolution): String =
        com.traza.core.units.AreaFormatter.format(solution.area, unitSystem)

    fun formatLength(metres: Double): String =
        LengthFormatter.format(com.traza.core.units.Length(metres), unitSystem)
